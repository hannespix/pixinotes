...
- 📋 **Kanban-Karten** mit frei benennbaren Spalten (Anzahl variabel), Ticket in die letzte Spalte schieben (auf Wunsch mit 🎉 Konfetti); Tickets können ein **Fälligkeitsdatum** (📅) tragen. Erledigte Tickets lassen sich **archivieren** — einzeln, gruppenweise, die ganze Spalte auf einmal oder **automatisch nach einstellbaren Tagen**; das Archiv der Karte holt sie jederzeit zurück. Die Erledigt-Spalte ordnet nach **Heute · Diese Woche · Älter** (Älter zugeklappt), die Kopfzeile hat nur Filter und ⋯, und **kompakte Tickets** zeigen nur Text, Priorität und Frist
...
- 🧩 **Kachel-Ansicht**: Kanban, Zeitplan, Wochenplan und Protokoll-Reihe lassen sich zur Kachel mit Kennzahlen zusammenklappen und öffnen sich im Fokus — das Board wächst nicht mehr mit jedem Modul
