...
- ▶️ **Präsentationsmodus mit Live-Bearbeitung**: Karten des Boards als Vollbild-Folien (Pfeiltasten/Esc) — Notizen, Formen, Diagramme und Kanban-Boards sind **direkt auf der Folie editierbar** (Tickets im Meeting weiterschieben!), alle Änderungen landen live auf dem Board
