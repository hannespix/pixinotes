          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-start">
              ...
              <ul>
                ...
                <li><b>Rahmen (Bereiche):</b> Über ＋ → „Rahmen (Bereich)" — ein benannter Rahmen gruppiert Karten optisch (Miro-Stil). An der <b>Titel-Leiste ziehen</b> verschiebt den Rahmen SAMT allen Karten darin; Doppelklick auf den Titel benennt um. Rahmen liegen immer hinter den Karten, das Aufräumen lässt sie in Ruhe, und im Präsentationsmodus wird der Name zur Abschnitts-Folie.</li>
