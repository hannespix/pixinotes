          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-start">
              ...
              <ul>
                ...
                <li><b>Auto-Größe:</b> Karte(n) auswählen → ⤢-Symbol in der Auswahl-Leiste — die Karte wächst dann automatisch mit ihrem Inhalt (gedrosselt, offene Menüs bleiben ungestört). Manuelles Ziehen an den Griffen schaltet die Automatik ab und deine Größe gilt; über dasselbe Symbol jederzeit wieder aktivierbar.</li>
