          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-karten">
              ...
              <ul>
                ...
                <li><b>🗓️ Kalender:</b> Monat/Woche, Quellen wählbar (Aufgaben, Zeitpläne, Meilensteine), ICS-Import/-Abo/-Export (Outlook, Google, Apple), .ics-Dateien einfach draufziehen. <b>Eigene Termine:</b> Klick auf einen Tag öffnet den Tages-Editor — Titel (+ optionale Uhrzeit) eintragen, fertig; ★-Einträge erscheinen im Raster und wandern beim Export mit. <b>Richtung Google/Outlook:</b> Jeder eigene Termin hat „→G" (öffnet Google Kalender mit vorausgefülltem Termin — ein Klick zum Speichern, ganz ohne Schreib-Zugriff auf dein Konto) und „.ics" für Outlook/Apple. <b>Richtung PixiNotes:</b> Über ⚙ → <b>Kalender</b> in den Einstellungen Google/Microsoft 365 verbinden (liest live) oder eine ICS-URL abonnieren. Einen automatischen Schreib-Sync in dein Konto gibt es bewusst nicht — dafür wären weitreichende Schreibrechte auf deinen kompletten Kalender nötig.</li>
