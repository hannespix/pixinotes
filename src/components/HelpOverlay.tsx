          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-karten">
              ...
              <ul>
                ...
                <li><b>🔗 Verbindungen als Daten-Abos:</b> Ein Pfeil zwischen Karten transportiert Daten. <b>Notiz/Zeitplan/Kanban → Kanban:</b> Die offenen Punkte der verbundenen Karte werden automatisch als Tickets eingesammelt — auch ohne den ⟳-Schalter und unabhängig von der Board-Auswahl. Abwählen geht jederzeit: im Einsammeln-Panel (⚙) den Haken der Quelle entfernen (Quellen mit Pfeil tragen dort ein „⇢ Abo"-Kennzeichen) oder einfach den Pfeil löschen. <b>Modul → Kalender:</b> Der Kalender springt auf den Bereich „Verbunden" und zeigt nur noch Termine, Fristen und Zeitplan-Balken der angeschlossenen Karten — der Bereich-Schalter in der Kopfzeile (Alle Boards / Dieses Board / Verbunden) stellt jederzeit um.</li>
