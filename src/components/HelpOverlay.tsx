          ...
          <div className="help-body help-neu">
            ...
            <section id="help-neu">
              ...
              <ul>
                ...
                <li><b>🔭 Das Netz öffnet als Karte, nicht als Lupe (M305):</b> Der Start-Ausschnitt war in festen Einheiten gerechnet — auf einem großen Schirm eine Nahaufnahme mit jedem Kartentitel. Jetzt ist der Maßstab fest (ein Bildpunkt je Einheit, Kugeln und Punkte ohne Titel), der Ausschnitt folgt dem Schirm: ein großer zeigt das ganze Netz mittig, ein Telefon die Umgebung des aktiven Boards.</li>
                <li><b>🗺️ Netz als Landkarte mit Inseln (M304):</b> Die Netzansicht kannte beim Aufbau weder Bereiche noch Projekte: Wikilinks zogen ein Urlaubs-Board mitten in die Arbeit, und die Bereichs-Hüllen lagen als lange Sicheln übereinander. Jetzt liegen Boards im Ring um ihr Projekt, Projekte im Ring um ihren Bereich, Bereiche nebeneinander. Die Hüllen überlappen sich nicht mehr und umschließen auch die Karten-Punkte, die Beschriftung sitzt über dem obersten Board, <b>„Alles einpassen"</b> zeigt das ganze Netz. Die <b>Physik</b> im Netz ist aus, bis man sie einschaltet (Leitplanke „ruhige Fläche"); eingeschaltet holt sie ein in einen fremden Bereich gezogenes Board zurück.</li>
