          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-start">
              ...
              <ul>
                ...
                <li><b>Auto-Größe:</b> Karte(n) auswählen → ⤢-Symbol in der Auswahl-Leiste — die Karte wächst dann automatisch mit ihrem Inhalt (gedrosselt, offene Menüs bleiben ungestört). <b>Manuelles Ziehen gewinnt immer:</b> es schaltet die Automatik ab, deine Größe wird nie von selbst geändert. Läuft der Inhalt später über, erscheint nur ein dezenter ⤢-Chip an der Karte als <b>Angebot</b> — ein Klick passt die Höhe einmalig an. Dauerhafte Auto-Größe jederzeit wieder über die Auswahl-Leiste. Wer die gesamte Automatik nicht möchte: ⚙ → Design → „Karten-Automatik" schaltet Auto-Größe und ⤢-Hinweise komplett ab.</li>
