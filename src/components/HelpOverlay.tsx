          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-daten">
              ...
              <ul>
                ...
                <li><b>Sync-Status oben:</b> Der ☁️-Chip in der Kopfleiste zeigt live, ob gespeichert wurde (✓ mit Uhrzeit per Hover), gerade gespeichert wird oder etwas hakt. <b>⚠️ „Zugriff erlauben"</b> heißt: Der Browser hat die Ordner-Freigabe nach einem Neustart zurückgesetzt — ein Klick auf den Chip genügt, und der Auto-Sync läuft weiter.</li>
