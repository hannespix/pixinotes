          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-karten">
              ...
              <ul>
                ...
                <li><b>📊 Diagramm (Mermaid):</b> liegt rahmenlos direkt auf der Fläche — alle Werkzeuge schweben als Leiste unterm Diagramm, sobald die Karte ausgewählt ist. 8 Vorlagen (Flow, Sequenz, Gantt, Mindmap, Kreis, Status, Zeitstrahl, Quadrant); Farbschema-Punkte, ✏️ Handschrift-Look und ⇄ Richtung liegen direkt in der Leiste — die Farbschemata färben alle Diagrammtypen (auch Kreis, Zeitstrahl, Quadrant, Gantt). Alle gängigen Typen bearbeitest du <b>direkt im Bild</b> — Flowchart: Klick auf einen Schritt → Form (▭ ▢ ◇ ◯), Füllfarbe, „→ Verbinden", Entfernen; Klick auf einen <b>Pfeil</b> → beschriften, Linienstil (─ ┄ ━), entfernen. Sequenz: Nachrichten und Personen anklicken (Text, Pfeilart, ＋ Person). Gantt: Balken anklicken (umbenennen, ±1 Tag, ＋ Aufgabe/Abschnitt). Mindmap: Punkte anklicken (＋ Unterpunkt, Teilbaum entfernen). Kreis: Legende anklicken (Wert ±5, ＋ Segment). Doppelklick = überall direkt umbenennen. Beim Laden einer Vorlage oder eines KI-Diagramms passt sich die Karte einmalig der Diagrammgröße an; „⤢ Einpassen" in der Leiste macht das jederzeit auf Klick — ansonsten bleibt die Größe genau so, wie du sie ziehst. Die ✨-Zeile in der Leiste erzeugt oder ändert das Diagramm aus normaler Sprache; der Code bleibt für Profis hinter ‹/›.</li>
