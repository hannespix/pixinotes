          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-karten">
              ...
              <ul>
                ...
                <li><b>Wochenplan (Stundenraster):</b> Über ＋ → „Wochenplan (Stunden)" — Tage als Spalten, Uhrzeiten als Zeilen. Klick auf einen freien Slot legt einen Block an (30-Minuten-Raster), Klick auf einen Block öffnet den Editor: Text, Tag, Von/Bis, Farbe, Löschen. Mo–Fr oder Mo–So und der Zeitbereich sind je Karte umschaltbar — so wird daraus Stundenplan, Arbeitswoche oder Dienstplan. Überlappende Blöcke stellen sich automatisch nebeneinander.</li>
