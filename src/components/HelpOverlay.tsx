          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-karten">
              ...
              <ul>
                ...
                <li><b>📊 Diagramm (Mermaid):</b> liegt rahmenlos direkt auf der Fläche — alle Werkzeuge schweben als Leiste unterm Diagramm, sobald die Karte ausgewählt ist. 8 Vorlagen (Flow, Sequenz, Gantt, Mindmap, Kreis, Status, Zeitstrahl, Quadrant), unter „Stil" Farbschemata, Handschrift-Look und Richtung. Flowcharts bearbeitest du <b>direkt im Bild</b>: Klick auf einen Schritt → Form (▭ ▢ ◇ ◯), Füllfarbe, „→ Verbinden", Danach-Schritt, Entfernen; Doppelklick = umbenennen direkt im Diagramm. Die Karte passt ihre Größe automatisch dem Inhalt an (große Gantt-Pläne bekommen echte Fläche); manuelles Ziehen an den Griffen schaltet auf feste Größe, „⤢ Auto" in der Leiste wieder zurück. Die ✨-Zeile in der Leiste erzeugt oder ändert das Diagramm aus normaler Sprache; der Code bleibt für Profis hinter ‹/›.</li>
