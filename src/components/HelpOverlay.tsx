          ...
          <div className="help-body" ref={bodyRef}>
            ...
            <section id="help-start">
              ...
              <ul>
                ...
                <li><b>Board-Optionen:</b> Die 🎨-Palette neben der Tab-Leiste gibt jedem Board eine eigene <b>Hintergrund-Tönung</b>. Im 🧹-Menü schaltet <b>„Gitter &amp; Raster-Fang"</b> ein Linien-Gitter ein, an dem Karten beim Verschieben einrasten. Der ⏱-Knopf im Dock öffnet einen <b>Besprechungs-Timer</b> (Countdown-Presets oder Stoppuhr) — bleibt auch im Präsentationsmodus sichtbar.</li>
